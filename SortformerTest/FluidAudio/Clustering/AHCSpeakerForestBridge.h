...
@property(nonatomic, readonly) const void *swiftEmbeddingPointer;

- (instancetype)initWithSwiftEmbeddingPointer:(const void *)swiftEmbeddingPointer NS_DESIGNATED_INITIALIZER;

- (instancetype)init NS_UNAVAILABLE;
@end

@interface AHCEmbeddingSegmentInput : NSObject
@property(nonatomic, readonly) NSUUID *segmentIdentifier;
...
@property(nonatomic, readonly) BOOL exceedsLinkageThreshold;
...
- (instancetype)initWithIndex:(NSInteger)index
      ...
      exceedsLinkageThreshold:(BOOL)exceedsLinkageThreshold NS_DESIGNATED_INITIALIZER;
